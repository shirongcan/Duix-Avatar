...
export const commonZh = {
  ...
  videoList: {
    ...
    replaceBackgroundTitle: '更换背景',
    replaceBackgroundDialogTitle: '人物抠像与背景替换',
    selectBackground: '选择图片或视频背景',
    backgroundTip: '视频背景较短时将自动循环播放，输出视频保留原声音。',
    startReplace: '开始处理',
    processingBackground: '正在用显卡抠像并合成背景，请勿关闭软件…',
    replaceBackgroundSuccess: '背景替换完成',
    replaceBackgroundFailed: '背景替换失败',
    makeFailedText: '制作失败',
    draftsText: '草稿',
  ...
  editView: {
    ...
    subtitle: '字幕',
    subtitleEnable: '烧录字幕',
    subtitleDescription: '将文案按时间轴永久显示在成片中',
...
export const commonEn = {
  ...
  videoList: {
    ...
    replaceBackgroundTitle: 'Background',
    replaceBackgroundDialogTitle: 'Remove and Replace Background',
    ...
    replaceBackgroundSuccess: 'Background replaced',
    replaceBackgroundFailed: 'Background replacement failed',
  ...
  editView: {
    ...
    subtitle: 'Subtitles',
    subtitleEnable: 'Burn in subtitles',
    subtitleDescription: 'Permanently render the script onto the final video',
