...
export const commonZh = {
  ...
  videoList: {
    ...
    editCopy: '编辑文案',
    backgroundTitle: '背景替换',
    backgroundEnable: '启用背景替换',
    backgroundTypeColor: '纯色背景',
    backgroundTypeImage: '图片背景',
    backgroundTypeVideo: '视频背景',
    backgroundColorLabel: '背景颜色',
    backgroundImageLabel: '背景图片',
    backgroundVideoLabel: '背景视频',
    backgroundUploadImage: '选择图片',
    backgroundUploadVideo: '选择视频',
    backgroundQualityLabel: '抠图精度',
    backgroundQualityFast: '快速',
    backgroundQualityHd: '高清',
    backgroundEdgeLabel: '边缘处理',
    backgroundEdgeNone: '无',
    backgroundEdgeFeather: '羽化',
    backgroundEdgeErode: '去边',
    backgroundEdgeAmount: '强度',
    backgroundPreview: '预览效果',
    backgroundStartReplace: '开始替换',
    backgroundReplaceSuccess: '背景替换成功，已保存到我的作品',
    backgroundReplaceFailed: '背景替换失败',
    keepSubtitles: '烧录字幕到新视频',
    keepSubtitlesTip: '开启后新视频会带上当前字幕样式',
    backgroundTip: '基于 GPU 人像抠像（RVM），支持图片或视频背景；视频背景会循环播放。'
  },
  myModelList: {
    emptyText: '您还没有专属模特',
    emptyLinkRouteText: '点击这里',
...
export const commonEn = {
  ...
  videoList: {
    ...
    backgroundEnable: 'Enable background replacement',
    ...
    backgroundUploadImage: 'Choose image',
    backgroundUploadVideo: 'Choose video',
    backgroundQualityLabel: 'Matting quality',
    backgroundQualityFast: 'Fast',
    backgroundQualityHd: 'HD',
    backgroundEdgeLabel: 'Edge',
    backgroundEdgeNone: 'None',
    backgroundEdgeFeather: 'Feather',
    backgroundEdgeErode: 'Trim',
    backgroundEdgeAmount: 'Amount',
    backgroundPreview: 'Preview',
    backgroundStartReplace: 'Start Replace',
    backgroundReplaceSuccess: 'Background replaced, saved to My Works',
    backgroundReplaceFailed: 'Background replacement failed',
    keepSubtitles: 'Burn subtitles into the new video',
    keepSubtitlesTip: 'The new video will include the current subtitle style',
    backgroundTip: 'GPU portrait matting (RVM) is used, image or video backgrounds are supported. Video backgrounds loop.'
  },
  myModelList: {
